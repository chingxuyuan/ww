...
public class PackageParser {
	...
	public static String parseAPK(String fileName) {
		...
		String path = gv.getServerRoot() + "/" + gv.getApkUploadDir() + fileName;
			...
			while ((type = parser.next()) != XmlPullParser.END_DOCUMENT) {
				...
				case XmlPullParser.START_TAG: {
					for (int i = 0, size = parser.getAttributeCount(); i != size; ++i) {
						...
						if (att.equals("versionCode")) {
							versionCode = value;
						}
						if (att.equals("versionName")) {
							versionName = value;
						}
						System.out.println(att + " " + value);
						if (att.equals("package")) {
							return value;
						}
